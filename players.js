...
const DEFAULT_PLAYERS_LIST = [
    {id: 1, name: "Алексей Беть", rating: 7.6, status: PLAYER_STATUS.REGULAR},
    ...
    {id: 9, name: "Дима Седов", rating: 8.7, status: PLAYER_STATUS.REGULAR},
    ...
    {id: 20, name: "Алексей Паук", rating: 9.1, status: PLAYER_STATUS.GUEST},
