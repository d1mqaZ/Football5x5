...
const DEFAULT_PLAYERS_LIST = [
    ...
    {id: 14, name: "Павел", rating: 5.8, status: PLAYER_STATUS.REGULAR},
    {id: 15, name: "Соколов Максим", rating: 5.3, status: PLAYER_STATUS.GUEST},
    {id: 16, name: "Дима Занько", rating: 8.2, status: PLAYER_STATUS.REGULAR},
    ...
    {id: 21, name: "Андрей Буштак", rating: 4.7, status: PLAYER_STATUS.REGULAR},
    {id: 22, name: "Андрей Здравков", rating: 7.4, status: PLAYER_STATUS.REGULAR},
    ...
    {id: 25, name: "Игорь Иванов", rating: 8.4, status: PLAYER_STATUS.REGULAR},
    {id: 26, name: "Сергей Кальчук", rating: 8.1, status: PLAYER_STATUS.REGULAR}
];
